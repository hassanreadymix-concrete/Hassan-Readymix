...
export const Hero: React.FC<HeroProps> = ({ onOpenQuoteModal }) => {
  ...
  return (
    <section id="home" className="relative pt-24 sm:pt-28 md:pt-32 pb-16 lg:pb-24 bg-[#F8FAFC] overflow-hidden blueprint-grid">
      {/* Background blueprint decorative geometric lines */}
      <div className="absolute top-10 left-10 w-96 h-96 border border-[#002D72]/10 rounded-full pointer-events-none" />
      <div className="absolute top-20 right-10 w-64 h-64 border border-[#002D72]/10 pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col justify-center">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-[#001F52] text-white text-[11px] font-bold tracking-[0.2em] uppercase rounded-xs mb-5 w-fit shadow-xs">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-[54px] xl:text-[62px] leading-[0.98] font-black text-[#001F52] uppercase font-heading mb-5 tracking-tight">
              Lahore's Trusted <br />
              <span className="relative inline-block text-[#001F52] pr-2">
                Ready-Mix Concrete<span className="text-[#C92323]">.</span>
                <span className="absolute bottom-1.5 left-0 w-full h-3 bg-[#F4C400]/40 -z-10" />
              </span><br />
              Poured for <br />
              <span className="bg-[#F4C400] text-[#001F52] px-3 py-0.5 inline-block shadow-sm">
                Maximum Strength.
              </span>
            </h1>

            {/* Supporting Paragraph */}
            <p className="text-[#475467] text-base sm:text-lg max-w-xl leading-relaxed mb-7 font-normal">
            ...
            <div className="flex flex-wrap items-center gap-3.5 mb-8">
              <a
                ...
                className="bg-[#F4C400] text-[#001F52] hover:bg-[#FFE066] px-6 sm:px-7 py-3.5 font-black text-sm uppercase tracking-wider transition-all rounded-xs border-b-4 border-[#D4AB00] shadow-md flex items-center gap-2.5 cursor-pointer"
              >
              ...
              <a
                ...
                className="bg-[#002D72] text-white hover:bg-[#001F52] px-6 sm:px-7 py-3.5 font-bold text-sm uppercase tracking-wider transition-all rounded-xs border-b-4 border-[#00183F] shadow-sm flex items-center gap-2 cursor-pointer"
              >
              ...
              <button
                ...
                className="bg-white text-[#001F52] hover:bg-[#001F52] hover:text-white border border-[#CBD5E1] px-5 py-3.5 font-bold text-xs uppercase tracking-wider transition-all rounded-xs shadow-xs flex items-center gap-2 cursor-pointer"
              >
            ...
            {/* Trust Badges Row */}
            <div className="pt-5 border-t border-[#E8EDF3] grid grid-cols-3 gap-3">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-sm bg-white border border-[#E8EDF3] flex items-center justify-center text-[#002D72] shadow-xs shrink-0">
                  <ShieldCheck className="w-4 h-4 text-[#002D72]" />
                </div>
                <div className="flex flex-col">
                  <span className="text-[11px] font-black text-[#001F52] uppercase leading-tight">ASTM C94 & C39</span>
                  <span className="text-[10px] text-[#667085]">Lab Tested PSI</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex flex-col">
                  <span className="text-[11px] font-black text-[#001F52] uppercase leading-tight">Transit Fleet</span>
                  <span className="text-[10px] text-[#667085]">Fast On-Site Pour</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex flex-col">
                  <span className="text-[11px] font-black text-[#001F52] uppercase leading-tight">All Lahore</span>
                  <span className="text-[10px] text-[#667085]">DHA, Bahria, Gulberg</span>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-6 relative">
            <div className="relative bg-[#00183F] p-2 sm:p-3 rounded-sm border-2 border-[#002D72] shadow-2xl overflow-hidden">
              
              {/* Top Status Bar in Visualizer */}
              <div className="bg-[#001F52] px-4 py-2.5 flex items-center justify-between border-b border-[#002D72] text-white text-xs mb-2">
                <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-3 text-[10px] font-mono-tech text-slate-300">
                  ...
                  <span className="bg-[#002D72] px-2 py-0.5 rounded text-white font-bold">ACTIVE</span>
                </div>
              </div>

              {/* Authentic Photo Viewer Container */}
              <div className="relative h-[280px] sm:h-[350px] lg:h-[390px] w-full overflow-hidden rounded-xs bg-[#00112C] group">
                <img
                  src={current.src}
                  alt={current.title}
                ...
                {/* Top Badge on Photo */}
                <div className="absolute top-3 left-3 bg-[#001F52]/90 backdrop-blur-xs border border-[#F4C400]/50 text-[#F4C400] text-[10px] font-mono-tech font-bold uppercase px-3 py-1 rounded-xs flex items-center gap-1.5 shadow-md">
